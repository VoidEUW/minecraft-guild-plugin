...
public class ClanJoinCommand implements SubCommand_I {
    private final Main plugin;

    public ClanJoinCommand(Main plugin) {
        this.plugin = plugin;
    }
    ...
    public void execute(CommandSender sender, String[] args) {
        ...
        // if clan is closed, needs an invitation or is full, send error message
        if (clan.isClosed() || clan.isFull() || clan.needsInvitation()) {
